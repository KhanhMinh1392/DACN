...
<!--        <h2 class="headline text-warning"> 404</h2>-->
        <div><img src="../img/ban.png" alt=""></div>
        <div class="error-content" style="margin-left: 10px; margin-top: 120px">
          ...
          <p>
            ...
            Vui lòng liên hệ <a href="#">minhdao933@gmail.com</a> để được cấp quyền.
          </p>
            <p style="text-align: center">
                <a href="<?php echo $_SERVER["PHP_SELF"]?>?LogOut=0">Đăng xuất khỏi hệ thống</a>.
            </p>
        </div>
        <!-- /.error-content -->
      </div>
