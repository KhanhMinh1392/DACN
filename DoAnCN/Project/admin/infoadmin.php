...
<?php
    ...
    $getProducts = "SELECT * FROM staffs WHERE idStaffs = '".$_GET["idAdmin"]."'";
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $sql = "UPDATE staffs SET NameStaff = '".$name."',Username = '".$email."',Password = '".$pass."',Birthday = '".$date."',Phone = '".$phone."', idRole = '".$role."', idStatus = '".$status_edit."' WHERE idStaffs = '".$_GET["idAdmin"]."'";
